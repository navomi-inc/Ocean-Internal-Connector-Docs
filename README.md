# CRM Connector API Spec OpenAPI Specification
[![Build Status](https://travis-ci.org/navomi-inc/Ocean-Internal-Connector-Docs.svg?branch=master)](https://travis-ci.org/navomi-inc/Ocean-Internal-Connector-Docs)
...
6. If you did everything correct, https://navomi-inc.github.io/Ocean-Internal-Connector-Docs/ will lead to your new docs
...
- Documentation(ReDoc): https://navomi-inc.github.io/Ocean-Internal-Connector-Docs/
- Look full spec:
    + JSON https://navomi-inc.github.io/Ocean-Internal-Connector-Docs/swagger.json
    + YAML https://navomi-inc.github.io/Ocean-Internal-Connector-Docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://navomi-inc.github.io/Ocean-Internal-Connector-Docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://navomi-inc.github.io/Ocean-Internal-Connector-Docs/ with url from the message: `Server started <url>`
